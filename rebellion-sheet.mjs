...
Hooks.once('init', () => {
	...
	Actors.registerSheet(CFG.id, RebellionSheet, { label: game.i18n.localize('PF1RS.Sheet.Rebellion'), types: [rebellionSheetId], makeDefault: true });
	Items.registerSheet(CFG.id, EventSheet, { label: game.i18n.localize('PF1RS.Sheet.Event'), types: [rebellionEventId], makeDefault: true });
	Items.registerSheet(CFG.id, TeamSheet, { label: game.i18n.localize('PF1RS.Sheet.Team'), types: [rebellionTeamId], makeDefault: true });
});